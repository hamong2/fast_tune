...
from data_loader.data_utils import (transform_axial, transform_sagittal, map_aparc_aseg2label,
...
class H5pyDataset:
    ...
    def transform(self, plane, imgs, zoom): # zoom size는 3*1행렬인데 그걸 계속 슬라이싱하다가 zoom이 사라져버리는 현상 발생
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hdf5_name', type=str, default="./dataset/140sub-20val/train_axial.hdf5",
    ...
    parser.add_argument('--data_dir', type=str, default="./dataset/140sub-20val/train", help="Directory with images to load")
    ...
    parser.add_argument('--gt_nocc', type=str, default="mri/aseg.auto_noCCseg.mgz",
    ...
    parser.add_argument('--edge_w', type=int, default=4, help="Weight for edges in weight mask. Default=5")
    parser.add_argument('--hires_w', type=int, default=4,
